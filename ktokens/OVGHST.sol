 ...
 * @author KEOM
 */
contract OVGHST is KToken, KErc20Storage {
    ...
    function rescueERC20(address _tokenAddress, address recipient) external {
        require(msg.sender == admin, "Unauthorized");
        uint256 tokenBalance = IEIP20(_tokenAddress).balanceOf(address(this));

        IEIP20(_tokenAddress).transfer(recipient, tokenBalance);
    }
