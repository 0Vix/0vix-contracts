...
@internal
def _deposit_for(_from: address, _to: address, _value: uint256, unlock_time: uint256, locked_balance: LockedBalance, type: int128):
    """
    ...
    log Deposit(_to, _value, _locked.end, type, block.timestamp)
